...
$routes->get('autologin/(:any)/(:any)', 'Auth::autoLogin/$1/$2');
...
$routes->get('admin/forum', 'Admin::fr');
$routes->get('admin/forum/(:any)/(:any)', 'Admin::forum/$1/$2');
...
$routes->get('admin/peserta/pengunjung', 'Admin::pengunjung');
