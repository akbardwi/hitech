<main>
    ...
    <div class="topic-container">
        ...
        <div class="comments-container" id="comment-<?= $data['id']; ?>">
            <div class="body">
                <div class="authors">
                    <div class="username"style="color: white;"><?= $data['nama']; ?> <span class="badge badge-<?php if($data['type_user'] == "peserta"){ echo "primary"; } else { echo "warning"; } ?>"><?= $data['type_user']; ?></span></div>
                    <br/>
                    <img src="<?= base_url("assets/vote/img/avatar.jpg"); ?>" alt="">
                </div>
                <div class="content">
