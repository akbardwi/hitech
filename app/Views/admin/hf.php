					...
					<table id="myTable" class="table table-striped table-bordered" style="width:100%; background: white">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <a href="javascript:void(0)" data-id="<?= $data['id']; ?>" data-type="hf" class="btn btn-primary btn-detail">Detail</a>
                                    <a href="javascript:void(0)" data-id="<?= $data['id']; ?>" data-type="hf" class="btn btn-primary btn-logo">Logo</a>
                    ...
                    <div class="modal-content">
                        ...
                        <form class="form-horizontal" action="<?php echo base_url("admin/uploadLogo"); ?>" method="post" enctype="multipart/form-data">
                            <div class="modal-body">
                                ...
                                <input type="hidden" name="type" value="hf" class="form-control">
