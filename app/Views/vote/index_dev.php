    <main>
        ...
        <p style="text-align: left; color: #fff">1. Developer <strong>WAJIB</strong> memberikan 1 pertanyaan yang nantinya apabila jawaban dari
        peserta benar maka Developer akan memberikan maksimal 5 koin kepada pengunjung.</p>
        <p style="text-align: left; color: #fff">2. Developer diharapkan “FAIR” dalam pemberian koin kepada pengunjung acara.</p>
        <p style="text-align: left; color: #fff">3. Developer wajib mematuhi peraturan yang sudah ditentukan panitia</p>
        </div>
        <br>
        <br>
    </main>